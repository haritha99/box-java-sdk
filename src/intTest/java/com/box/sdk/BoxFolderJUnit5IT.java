 ...
 */
//@ExtendWith(SetupApiExtension.class)
public class BoxFolderJUnit5IT {
    ...
    @Test
    @DisplayName("creating and deleting folder succeeds")
...
//
//            assertThat(rootFolder, hasItem(Matchers.<BoxItem.Info>hasProperty("ID", equalTo(uploadedFile.getID()))));
//            assertTrue(callbackWasCalled.get(), "Callback was not called");
//        } finally {
//            this.deleteFile(uploadedFile);
//        }
//    }
...
//            assertNotNull(actualMD, "Metadata should not be null for this folder");
